...
const mapStateToProps = (state) => {
    ...
    return { FlashSaleData: state.FlashSaleReducer.FlashSaleData, CategoryData: state.NestedcategoryReducer.NestedCategoryData, loading: state.FlashSaleReducer.loading }
