...
export default connect(mapStateToProps)(class Product extends React.Component {
    ...
    constructor(props) {
        ...
        store.dispatch(SingleProductAction(1))
        this.state = {
            imagePath: null,
            thumbnail: null,
            variationthumb: null
    ...
    variationimage = (id) => {
        ...
        const x = this.props.SingleProductData.variation.filter(data => data.id == id)
    ...
    render() {
        ...
        console.log(this.props.SingleProductData, this.state.thumbnail, this.state.variationthumb)
                ...
                <section class="mt-8" >
                    <div class="container">
                        <div class="row" >
                            ...
                            {this.props.SingleProductData == undefined ? null :
                                ...
                                (
                                    <div class="col-md-5" style={{ padding: "10px" }}>
                                        <div class="ps-lg-10 mt-6 mt-md-0">
                                            ...
                                            <h1 class="mb-1">{this.props.SingleProductData.title} </h1>
                                            <div class="mb-4">
